/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 54e6d302cdb08c41ee0ed75557529917)
// Runtime types generated with workerd@1.20260409.1 2026-04-10 
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "CartHubDO";
	}
	interface Env {
		TURSO_CONNECTION_URL: string;
		TURSO_AUTH_TOKEN: string;
		JWT_SECRET: string;
		CartHubDO: DurableObjectNamespace<import("./src/index").CartHubDO>;
	}
}
